...
user1.make_deposit(100).make_deposit(200).make_deposit(50).make_withdrawal(50)
user1.display_user_balance()

# Have the second user make 2 deposits and 2 withdrawal and then display their balance
user2.make_deposit(100).make_deposit(100).make_withdrawal(50).make_withdrawal(100)
user2.display_user_balance()

# Have the third user make 1 deposits and 3 withdrawal and then display their balance
user3.make_deposit(500).make_withdrawal(100).make_withdrawal(100).make_withdrawal(50)
