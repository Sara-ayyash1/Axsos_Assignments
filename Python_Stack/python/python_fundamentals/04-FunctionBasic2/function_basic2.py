# 1)Countdown - Create a function that accepts a number as an input. Return a new list that counts down by one, from the number down to 0 (as the last element).
def countdown(num):
    new_list =[]
